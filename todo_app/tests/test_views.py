...
class TESTUserProfileUpdateAPIView(APITestCase):
    ...
    def test_update_bad_request_wrong_password(self):
    ...
    def test_update_bad_request_duplicate_email(self):
...
class TESTTaskCreateAPIView(APITestCase):
    ...
    def test_create_bad_request_blank_title(self):
...
class TESTTaskUPDATEAPIView(APITestCase):
    ...
    def test_update_success(self):
        ...
        response = self.client.patch(self.TARGET_URL+str(task.pk)+'/', params, format='json')
        self.assertEqual(Task.objects.count(), 1)
        self.assertEqual(response.status_code, 200)
        task = Task.objects.get()
        expected_json_dict = {
    ...
    def test_update_bad_request_blank_title(self):
...
class TESTTaskDeleteAPIView(APITestCase):
    ...
    def test_delete_success(self):
        ...
        task = Task.objects.get()
        response = self.client.delete(self.TARGET_URL+str(task.pk)+'/', params, format='json')
        self.assertEqual(response.status_code, 204)

    def test_delete_bad_requeset_task_pk(self):
        ...
        response = self.client.post(self.TASKCREATE_URL, params, format='json')
        self.assertEqual(Task.objects.count(), 1)
        response = self.client.delete(self.TARGET_URL+str(0)+'/', params, format='json')
